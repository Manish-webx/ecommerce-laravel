...
class OutOfDeliveryOrderDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
     {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $editBtn = "<a href=' " .route('admin.order.show', $query->id).  " '  class='btn btn-primary text-white'><i class='far fa-eye'></i></a>";
                $deleteBtn = "<a href=' ". route('admin.order.destroy', $query->id) . " '  class='btn btn-danger text-white ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
            ...
            ->rawColumns(['action', 'order_status', 'amount', 'payment_status'])
            ->setRowId('id');
    }
