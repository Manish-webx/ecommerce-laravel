                  ...
                  <div class="row">
                    ...
                    <div class="col-9">
                      <div class="tab-content" id="nav-tabContent">
                        @include('admin.payment-setting.section.paypal-setting')
                        
                        @include('admin.payment-setting.section.stripe-setting')
                        
                        @include('admin.payment-setting.section.razorpay-setting')
