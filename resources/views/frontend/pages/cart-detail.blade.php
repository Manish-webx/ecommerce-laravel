            ...
            <div class="row">
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        <h6>total cart</h6>
                        <p>subtotal: <span id="sub_total">{{$setting->currency_icon}}{{sidebarProductTotal()}}</span></p>
                        <p>discount: <span id="discount_total">{{$setting->currency_icon}}{{getCartDiscount()}}</span></p>
                        <p class="total"><span>total:</span> <span id="cart_total">{{$setting->currency_icon}}{{getMainCartTotal()}}</span></p>

                        <form id="coupon_form">
                            <input type="text" placeholder="Coupon Code" name="coupon" value="{{session()->has('coupon') ? session()->get('coupon')['coupon_code'] : ''}}">
        ...
        $(document).ready(function(){
            ...
            function calculateCoupon(){
                $.ajax({
                   ...
                   success:function(data){
                     $('#discount_total').text("{{$setting->currency_icon}}" + data.discount);
                     $('#cart_total').text("{{$setting->currency_icon}}" + data.total);
                   },
                   error:function(data){
