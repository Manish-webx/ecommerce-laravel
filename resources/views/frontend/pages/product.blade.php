                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="row">
                            ...
                            <div class="wsus__product_topbar">
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link {{session()->has('product_view_type')  && session()->get('product_view_type') === 'grid' ? 'active' : '' }} {{!session('product_view_type') ? 'active' : ''}} list-type" data-id="grid" id="v-pills-home-tab" data-bs-toggle="pill"
                                            data-bs-target="#v-pills-home" type="button" role="tab"
                                            aria-controls="v-pills-home" aria-selected="true">
                                            <i class="fas fa-th"></i>
                                        </button>
                                        <button class="nav-link {{session()->has('product_view_type')  && session()->get('product_view_type') === 'list' ? 'active' : '' }} list-type"  data-id="list" id="v-pills-profile-tab" data-bs-toggle="pill"
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade {{session()->has('product_view_type')  && session()->get('product_view_type') === 'grid' ? 'show active' : '' }} {{!session('product_view_type') ? 'show active' : ''}}" id="v-pills-home" role="tabpanel"
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="wsus__product_item">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <a class="wsus__pro_name" href="{{route('product-detail', $product->slug)}}">{{textlimit($product->name, 4)}}</a>
                            ...
                            <div class="tab-pane fade {{session()->has('product_view_type')  && session()->get('product_view_type') === 'list' ? 'show active' : '' }}" id="v-pills-profile" role="tabpanel"
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                <ul class="wsus__single_pro_icon">                                                    
                                                    <form class="shopping-cart-form">                               
                                                        ...
                                                        <input name="qty" class="" type="hidden" min="1" max="100" value="1" />                              
                                                        <li><button type="submit" class="add_cart" style="margin-right:10px">add to cart</button></li>
                                                    </form>
                                                    <li><a href="#" data-id="{{$product->id}}" class="add-to-wishlist"><i class="far fa-heart"></i></a></li>
                                                    {{-- <li><a href="#"><i class="far fa-random"></i></a> --}}
                                                </ul>
...
@push('scripts')
   ...
   $(document).ready(function(){
        $('.list-type').on('click', function(){
            let view_type = $(this).data('id');
            $.ajax({
                method: 'GET',
                url: "{{route('product-view-list-type')}}",
